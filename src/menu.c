...
static GtkItemFactoryEntry menu_items[] =
{
	...
	{ "/File/---", NULL,
		NULL, 0, "<Separator>" },
	{ N_("/File/Sta_tistics..."), NULL,
		G_CALLBACK(on_file_stats), 0, "<StockItem>", GTK_STOCK_PROPERTIES },
#ifdef ENABLE_PRINT
...
#	endif
	...
	{ N_("/_View"),	 NULL,
		NULL, 0, "<Branch>" },
	{ N_("/View/_Fullscreen"), "F11",
		G_CALLBACK(on_view_fullscreen), 0, "<CheckItem>" },
	{ N_("/_Search"),	 NULL,
		NULL, 0, "<Branch>" },
...
GtkWidget *create_menu_bar(GtkWidget *window)
{
	...
	ifactory = gtk_item_factory_new(ITEM_FACTORY_TYPE, "<main>", accel_group);

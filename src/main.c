...
gint main(gint argc, gchar **argv)
{
	...
	osso_context_t *ctx = osso_initialize (PACKAGE, PACKAGE_VERSION, TRUE, NULL);
#endif
	...
	hildon_program_add_window (hildon_prog, HILDON_WINDOW (pub->mw->window));
#endif
